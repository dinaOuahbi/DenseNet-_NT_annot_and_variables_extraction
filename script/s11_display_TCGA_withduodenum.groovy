...
def file2 = "/work/shared/ptbc/CNN_Pancreas_V2/Donnees/project_kernel03_scan21000500/Results/SCNN/CombModels_BSC_prediction_without_border/"+shortname+".csv"
...
/*def csvReader = new BufferedReader(new FileReader('K:/Valentin/A14-530_ERG_2.csv'))
*/
...
// new dir for output
File fullPath = new File('/work/shared/ptbc/CNN_Pancreas_V2/Donnees/project_kernel03_scan21000500/Results/SCNN/QPdata_withduodenum/'+shortname+'/')
if (!fullPath.exists())
    fullPath.mkdirs()

// Save qpadata of this //
def img1 = getCurrentImageData()
def qpdata1 = new File('/work/shared/ptbc/CNN_Pancreas_V2/Donnees/project_kernel03_scan21000500/Results/SCNN/QPdata_withduodenum/'+shortname+'/'+shortname+'_2.qpdata')
...
def outputPath = buildFilePath(slide+shortname+"_2.tif")
